...
VALUES (1, gen_random_uuid(), 'FIXED', 'S', 'Red', 'Cotton', 50, 20, 8, 0, 'Model-S', 'Small size red T-shirt', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       (1, gen_random_uuid(), 'FIXED', 'M', 'Blue', 'Cotton', 60, 20, 8, 0, 'Model-M', 'Medium size blue T-shirt',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (1, gen_random_uuid(), 'FIXED', 'L', 'Green', 'Cotton', 40, 20, 8, 0, 'Model-L', 'Large size green T-shirt',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (2, gen_random_uuid(), NULL, 'M', 'White', 'Cotton', 30, 30, 0, 0, 'Model-M', 'Medium formal white shirt', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       (2, gen_random_uuid(), NULL, 'L', 'Light Blue', 'Cotton', 20, 30, 0, 0, 'Model-L',
        'Large formal light blue shirt', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (3, gen_random_uuid(), NULL, 'M', 'Black', 'Leather', 25, 100, 0, 0, 'Model-M',
        'Medium-sized black leather jacket', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (3, gen_random_uuid(), 'FIXED', 'L', 'Brown', 'Leather', 15, 120, 10, 0, 'Model-L',
        'Large-sized brown leather jacket', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (4, gen_random_uuid(), NULL, NULL, 'Gray', 'Synthetic', 40, 10, 0, 0, 'Model-SHOE',
        'Gray running shoes with 10% discount', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (4, gen_random_uuid(), 'PERCENTAGE', NULL, 'Black', 'Synthetic', 35, 15, 0, 15, 'Model-SHOE',
        'Black running shoes with 15% discount', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (5, gen_random_uuid(), 'FIXED', NULL, 'Navy Blue', 'Polyester', 100, 10, 0, 40, 'Model-BP',
        'Navy blue backpack with spacious compartments', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (5, gen_random_uuid(), NULL, NULL, 'Gray', 'Polyester', 85, 40, 0, 0, 'Model-BP',
        'Gray backpack with laptop sleeve', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (6, gen_random_uuid(), NULL, 'S', 'Red', 'Silk', 20, 150, 0, 0, 'Model-S', 'Small-sized red silk party dress',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (6, gen_random_uuid(), NULL, 'M', 'Emerald Green', 'Silk', 25, 180, 0, 0, 'Model-M',
        'Medium-sized emerald green silk party dress', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (7, gen_random_uuid(), 'FIXED', 'M', 'Beige', 'Cotton', 40, 50, 10, 0, 'Model-32',
        'Medium beige casual trousers', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (7, gen_random_uuid(), NULL, 'L', 'Olive Green', 'Cotton', 30, 50, 0, 0, 'Model-34',
        'Large olive green casual trousers', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (7, gen_random_uuid(), 'FIXED', 'M', 'Navy Blue', 'Wool', 15, 180, 10, 0, 'Model-M',
        'Medium size navy blue wool coat', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (7, gen_random_uuid(), NULL, 'L', 'Black', 'Wool', 20, 200, 0, 0, 'Model-L', 'Large size black wool coat', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       ...
       (8, gen_random_uuid(), NULL, 'S', 'Dark Blue', 'Denim', 30, 50, 0, 0, 'Model-S', 'Small size dark blue jeans',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (8, gen_random_uuid(), NULL, 'M', 'Black', 'Denim', 25, 55, 0, 0, 'Model-M', 'Medium size black jeans', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       (8, gen_random_uuid(), 'PERCENTAGE', 'L', 'Light Blue', 'Denim', 20, 10, 0, 20, 'Model-L',
        'Large size light blue jeans with 10% discount', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (9, gen_random_uuid(), 'PERCENTAGE', NULL, 'White', 'Canvas', 50, 15, 0, 10, 'Model-SNK',
        'White canvas sneakers with 15% discount', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (9, gen_random_uuid(), NULL, NULL, 'Black', 'Canvas', 40, 60, 0, 0, 'Model-SNK', 'Black canvas sneakers', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       (9, gen_random_uuid(), NULL, NULL, 'Gray', 'Canvas', 30, 55, 0, 0, 'Model-SNK', 'Gray canvas sneakers', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       (10, gen_random_uuid(), NULL, NULL, 'Tan', 'Leather', 25, 120, 0, 0, 'Model-HB', 'Tan leather handbag', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       (10, gen_random_uuid(), NULL, NULL, 'Black', 'Leather', 30, 140, 0, 0, 'Model-HB', 'Black leather handbag',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (10, gen_random_uuid(), 'PERCENTAGE', NULL, 'Red', 'Leather', 20, 20, 0, 10, 'Model-HB',
        'Red leather handbag with 20% discount', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (11, gen_random_uuid(), 'FIXED', NULL, 'Beige', 'Straw', 40, 30, 10, 0, 'Model-SH', 'Beige straw summer hat',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (11, gen_random_uuid(), 'FIXED', NULL, 'White', 'Cotton', 50, 35, 10, 0, 'Model-SH', 'White cotton summer hat',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (11, gen_random_uuid(), 'PERCENTAGE', NULL, 'Navy', 'Cotton', 35, 10, 0, 5, 'Model-SH',
        'Navy cotton summer hat with 10% discount', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (12, gen_random_uuid(), 'PERCENTAGE', 'M', 'Red', 'Polyester', 50, 15, 0, 5, 'Model-SW',
        'Medium size red polyester sportswear with 15% discount', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (12, gen_random_uuid(), NULL, 'L', 'Blue', 'Polyester', 40, 45, 0, 0, 'Model-SW',
        'Large size blue polyester sportswear', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (12, gen_random_uuid(), NULL, 'S', 'Black', 'Polyester', 30, 40, 0, 0, 'Model-SW',
       ...
       (13, gen_random_uuid(), NULL, 'L', 'Navy Blue', 'Silk', 15, 300, 0, 0, 'Model-L',
       ...
       (14, gen_random_uuid(), NULL, NULL, 'Gold', 'Metal', 20, 350, 0, 0, 'Model-WT', 'Gold metallic watch', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       (14, gen_random_uuid(), NULL, NULL, 'Silver', 'Metal', 25, 300, 0, 0, 'Model-WT', 'Silver metallic watch', NOW(),
        NOW(), 'anonymousUser', 'anonymousUser'),
       ...
       (15, gen_random_uuid(), NULL, 'M', 'Khaki', 'Cotton', 30, 45, 0, 0, 'Model-CT',
        'Medium size khaki cotton trousers', NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
       (15, gen_random_uuid(), NULL, 'L', 'Gray', 'Cotton', 20, 50, 0, 0, 'Model-CT', 'Large size gray cotton trousers',
        NOW(), NOW(), 'anonymousUser', 'anonymousUser'),
