          ...
          <tbody>
            {_.map(variants, (variant) => (
              <tr key={variant.id} className="border-b hover:bg-gray-50">
                ...
                <td className="px-2 py-2 text-sm">
                  <button
                    onClick={() => onUpdateClick(variant)}
                    className="p-1 text-blue-500 hover:blue-red-600 hover:bg-blue-100 rounded transition-colors duration-300"
                  >
                    Update Stock
                  </button>
                </td>
